...
import { TransportDoc } from '@/models/transport';
...
const Page = () => {
    ...
    const [transports, setTransports] = useState<TransportDoc[]>([]);
    ...
    useEffect(() => {
        ...
        .then(response => {
            response.json()
            .then((data: {transports: TransportDoc[]}) => setTransports(data.transports))
